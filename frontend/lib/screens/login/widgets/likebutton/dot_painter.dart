...
class DotPainter extends CustomPainter {
  ...
  late double maxOuterDotsRadius;
  late double maxInnerDotsRadius;
  late double maxDotSize;
  ...
  DotPainter({
    ...
    this.color4 = const Color(0xFFF44336),
            ...
            List.generate(4, (_) => Paint()..style = PaintingStyle.fill);

  double outerDotsPositionAngle = 360.0 / 7;
