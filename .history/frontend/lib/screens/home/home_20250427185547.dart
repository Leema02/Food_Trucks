  ...
  Widget _buildCurrentLocationTile() {
    return ListTile(
      ...
      onTap: () async {
        ...
        // Delay a little after closing
        await Future.delayed(const Duration(milliseconds: 200));

        try {
          // 🧡 Freshly get the real latest location!
          ...
          // Fetch the city name for the new position
          List<Placemark> placemarks = await placemarkFromCoordinates(
            position.latitude,
            position.longitude,
          );
          ...
          if (placemarks.isNotEmpty) {
            ...
            setState(() {
              currentLocation = position; // 🔥 Save the new location
