// 📄 Full Corrected HomePage.dart (fixed Choose Location + Home Tabs)
...
class HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  Widget _buildCurrentLocationTile() {
    return ListTile(
      ...
      subtitle: const Text("Detect and move to your location"),
        ...
        try {
          ...
          if (placemarks.isNotEmpty) {
            ...
            String correctedCity =
                cityCorrections[detectedCity] ?? detectedCity;

            setState(() {
              _currentCityName = correctedCity;
            });

            // ✅ Step 3: Move the map center to fresh position
            _mapController.move(
