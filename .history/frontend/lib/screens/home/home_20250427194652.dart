  ...
  Widget buildEndDrawer() {
    return Align(
      ...
      child: Container(
        ...
        height: 150,
        decoration: BoxDecoration(
          color: Colors.white, // Background for whole contact box
              ...
              child: GestureDetector(
                ...
                child: Container(
                  decoration: const BoxDecoration(
                    color: Color(0xFFFFA726), // Light orange for top button
            ...
            Expanded(
              child: GestureDetector(
                ...
                child: Container(
                  decoration: const BoxDecoration(
                    color:
                        Color(0xFFFFCC80), // Lighter orange for bottom button
                    borderRadius: BorderRadius.only(
                      bottomLeft: Radius.circular(16),
                    ),
                  ),
