...
class HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  Widget _buildCurrentLocationTile() {
    return ListTile(
      ...
      subtitle: const Text("The app will use your current location"),
      ...
      onTap: () async {
        ...
        try {
          // ⚡ Step 1: Get last known position very fast
          ...
          if (lastKnown != null) {
            ...
            setState(() {
              ...
              _currentCityName = "Current Location";
            });
          }

          // ⚡ Step 2: Meanwhile fetch a fresh location (does not block user)
